...
Opal.modules["bigdecimal/kernel"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$BigDecimal', TMP_1 = function ːBigDecimal(initial, digits) {
      var self = this;
...
Opal.modules["bigdecimal"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defs(self, '$limit', TMP_1 = function ːlimit(digits) {
      var self = this;
    ...
    Opal.defs(self, '$mode', TMP_2 = function ːmode(mode, value) {
    ...
    Opal.defn(self, '$initialize', TMP_3 = function ːinitialize(initial, digits) {
      var self = this;
    ...
    Opal.defn(self, '$abs', TMP_10 = function ːabs() {
      var self = this;

      return self.$class().$new(self.$bignumber().abs());
    }, TMP_10.$$arity = 0);

    Opal.defn(self, '$add', TMP_11 = function ːadd(other, digits) {
    ...
    Opal.defn(self, '$ceil', TMP_12 = function ːceil(n) {
      var $a, self = this;
    ...
    Opal.defn(self, '$coerce', TMP_13 = function ːcoerce(other) {
      var self = this, $case = nil;
    ...
    Opal.defn(self, '$div', TMP_14 = function ːdiv(other, digits) {
    ...
    Opal.defn(self, '$minus', TMP_17 = function ːminus(other) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.defn(self, '$mult', TMP_18 = function ːmult(other, digits) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.defn(self, '$quo', TMP_20 = function ːquo(other) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.defn(self, '$sign', TMP_21 = function ːsign() {
      var $a, self = this;
    ...
    Opal.defn(self, '$sub', TMP_22 = function ːsub(other, precision) {
      var $a, $b, self = this, _ = nil;
    ...
    Opal.defn(self, '$to_f', TMP_23 = function ːto_f() {
      var self = this;

      return self.$bignumber().toNumber();
    }, TMP_23.$$arity = 0);

    Opal.defn(self, '$to_s', TMP_24 = function ːto_s(s) {
      var self = this;
