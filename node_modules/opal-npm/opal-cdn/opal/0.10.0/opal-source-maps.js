...
Opal.modules["opal/source_map"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(fragments, file) {
        var self = this;
      ...
      Opal.defn(self, '$map', TMP_3 = function ːmap() {
...
if (fragment == null) fragment = nil;
      ...
      Opal.defn(self, '$as_json', TMP_4 = function ːas_json() {
        var self = this;

        return self.$map().$as_json();
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$to_json', TMP_5 = function ːto_json() {
        var self = this;

        return self.$map().$as_json();
      }, TMP_5.$$arity = 0);

      Opal.defn(self, '$to_s', TMP_6 = function ːto_s() {
        var self = this;

        return self.$map().$to_s();
      }, TMP_6.$$arity = 0);

      return (Opal.defn(self, '$magic_comment', TMP_7 = function ːmagic_comment(map_path) {
        var self = this;
