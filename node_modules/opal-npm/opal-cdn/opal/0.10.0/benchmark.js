...
Opal.modules["benchmark"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$benchmark', TMP_1 = function ːbenchmark(caption, label_width, format, $a_rest) {
...
if (t == null) t = nil;
    ...
    Opal.defn(self, '$bm', TMP_3 = function ːbm(label_width, $a_rest) {
    ...
    Opal.defn(self, '$bmbm', TMP_4 = function ːbmbm(width) {
...
if (res == null) res = nil;
    ...
    Opal.defn(self, '$measure', TMP_8 = function ːmeasure(label) {
    ...
    Opal.defn(self, '$realtime', TMP_9 = function ːrealtime() {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_10 = function ːinitialize(width) {
        var self = this;
      ...
      Opal.defn(self, '$item', TMP_11 = function ːitem(label) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_12 = function ːinitialize(width, format) {
        var $a, self = this;
      ...
      Opal.defn(self, '$item', TMP_13 = function ːitem(label, $a_rest) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_14 = function ːinitialize(utime, stime, cutime, cstime, real, label) {
        var $a, self = this;
      ...
      Opal.defn(self, '$add', TMP_15 = function ːadd() {
      ...
      Opal.defn(self, '$format', TMP_28 = function ːformat(format, $a_rest) {
      ...
      Opal.defn(self, '$to_a', TMP_30 = function ːto_a() {
        var self = this;
      ...
      return (Opal.defn(self, '$memberwise', TMP_31 = function ːmemberwise(op, x) {
