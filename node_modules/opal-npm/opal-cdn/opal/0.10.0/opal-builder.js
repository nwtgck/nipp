...
Opal.modules["hike/normalized_array"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_6, TMP_7, TMP_8, TMP_9, TMP_11;
      ...
      Opal.defn(self, '$[]=', TMP_2 = function($a_rest) {
        var $b, $c, self = this, args, $iter = TMP_2.$$p, $yield = $iter || nil, value = nil;
        ...
        TMP_2.$$p = null;
        value = args.$pop();
        if ((($b = value['$respond_to?']("to_ary")) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
          value = self.$normalize_elements(value)
          } else {
          value = self.$normalize_element(value)
        };
        return ($b = ($c = self, Opal.find_super_dispatcher(self, '[]=', TMP_2, false)), $b.$$p = null, $b).apply($c, Opal.to_a(args.$concat([value])));
      }, TMP_2.$$arity = -1);

      Opal.defn(self, '$<<', TMP_3 = function(element) {
        var $a, $b, self = this, $iter = TMP_3.$$p, $yield = $iter || nil;

        TMP_3.$$p = null;
        return ($a = ($b = self, Opal.find_super_dispatcher(self, '<<', TMP_3, false)), $a.$$p = null, $a).call($b, self.$normalize_element(element));
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$collect!', TMP_4 = function() {
        var $a, $b, TMP_5, self = this, $iter = TMP_4.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
        ...
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'collect!', TMP_4, false)), $a.$$p = (TMP_5 = function(element){var self = TMP_5.$$s || this, result = nil;
if (element == null) element = nil;
        result = Opal.yield1($yield, element);
          return self.$normalize_element(result);}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).apply($b, $zuper);
      }, TMP_4.$$arity = 0);

      self.$alias_method("map!", "collect!");

      Opal.defn(self, '$insert', TMP_6 = function ːinsert(index, $a_rest) {
        var $b, $c, self = this, elements, $iter = TMP_6.$$p, $yield = $iter || nil;

        var $args_len = arguments.length, $rest_len = $args_len - 1;
        if ($rest_len < 0) { $rest_len = 0; }
        elements = new Array($rest_len);
        for (var $arg_idx = 1; $arg_idx < $args_len; $arg_idx++) {
          elements[$arg_idx - 1] = arguments[$arg_idx];
        }
        TMP_6.$$p = null;
        return ($b = ($c = self, Opal.find_super_dispatcher(self, 'insert', TMP_6, false)), $b.$$p = null, $b).apply($c, [index].concat(Opal.to_a(self.$normalize_elements(elements))));
      }, TMP_6.$$arity = -2);

      Opal.defn(self, '$push', TMP_7 = function ːpush($a_rest) {
        var $b, $c, self = this, elements, $iter = TMP_7.$$p, $yield = $iter || nil;

        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        elements = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
          elements[$arg_idx - 0] = arguments[$arg_idx];
        }
        TMP_7.$$p = null;
        return ($b = ($c = self, Opal.find_super_dispatcher(self, 'push', TMP_7, false)), $b.$$p = null, $b).apply($c, Opal.to_a(self.$normalize_elements(elements)));
      }, TMP_7.$$arity = -1);

      Opal.defn(self, '$replace', TMP_8 = function ːreplace(elements) {
        var $a, $b, self = this, $iter = TMP_8.$$p, $yield = $iter || nil;

        TMP_8.$$p = null;
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'replace', TMP_8, false)), $a.$$p = null, $a).call($b, self.$normalize_elements(elements));
      }, TMP_8.$$arity = 1);

      Opal.defn(self, '$unshift', TMP_9 = function ːunshift($a_rest) {
        var $b, $c, self = this, elements, $iter = TMP_9.$$p, $yield = $iter || nil;
        ...
        TMP_9.$$p = null;
        return ($b = ($c = self, Opal.find_super_dispatcher(self, 'unshift', TMP_9, false)), $b.$$p = null, $b).apply($c, Opal.to_a(self.$normalize_elements(elements)));
      }, TMP_9.$$arity = -1);

      return (Opal.defn(self, '$normalize_elements', TMP_11 = function ːnormalize_elements(elements) {
        var $a, $b, TMP_10, self = this;

        return ($a = ($b = elements).$map, $a.$$p = (TMP_10 = function(element){var self = TMP_10.$$s || this;
if (element == null) element = nil;
        return self.$normalize_element(element)}, TMP_10.$$s = self, TMP_10.$$arity = 1, TMP_10), $a).call($b);
      }, TMP_11.$$arity = 1), nil) && 'normalize_elements';
    })($scope.base, $scope.get('Array'))
  })($scope.base)
};
/* Generated by Opal 0.10.0 */
Opal.modules["hike/extensions"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (Opal.defn(self, '$normalize_element', TMP_1 = function ːnormalize_element(extension) {
        var $a, self = this;

        if ((($a = extension['$[]'](/^\./)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return extension
          } else {
          return "." + (extension)
        };
      }, TMP_1.$$arity = 1), nil) && 'normalize_element'
    })($scope.base, $scope.get('NormalizedArray'))
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
...
/* Generated by Opal 0.10.0 */
Opal.modules["hike/index"] = function(Opal) {
  function $rb_plus(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs + rhs : lhs['$+'](rhs);
  }
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass, $hash2 = Opal.hash2;

  Opal.add_stubs(['$require', '$attr_reader', '$freeze', '$dup', '$inject', '$[]=', '$map', '$new', '$to_s', '$extract_options!', '$[]', '$each', '$sub', '$relative?', '$find_in_base_path', '$to_proc', '$find_in_paths', '$find', '$directory?', '$sort', '$reject', '$=~', '$entries', '$key?', '$exist?', '$stat', '$protected', '$is_a?', '$last', '$pop', '$split', '$match', '$join', '$paths_contain?', '$pattern_for', '$select', '$file?', '$sort_matches', '$any?', '$==', '$length', '$paths', '$build_pattern_for', '$extname', '$find_aliases_for', '$basename', '$+', '$escape', '$extensions', '$sort_by', '$scan', '$index', '$push']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_3, TMP_4, TMP_5, TMP_6, TMP_10, TMP_11, TMP_12, TMP_13, TMP_14, TMP_16, TMP_19, TMP_21, TMP_22, TMP_25, TMP_28, TMP_30;
      ...
      Opal.defn(self, '$initialize', TMP_3 = function ːinitialize(root, paths, extensions, aliases) {
        var $a, $b, TMP_1, $c, TMP_2, self = this;

        self.root = root;
        self.paths = paths.$dup().$freeze();
        self.extensions = extensions.$dup().$freeze();
        self.aliases = ($a = ($b = aliases).$inject, $a.$$p = (TMP_1 = function(h, $c){var self = TMP_1.$$s || this, $c_args, k, a;
          ...
          a = $c_args.splice(0,1)[0];
          if (a == null) {
            a = nil;
          }if (h == null) h = nil;
        h['$[]='](k, a.$dup().$freeze());
          return h;}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1.$$has_top_level_mlhs_arg = true, TMP_1), $a).call($b, $hash2([], {})).$freeze();
        self.pathnames = ($a = ($c = paths).$map, $a.$$p = (TMP_2 = function(path){var self = TMP_2.$$s || this;
if (path == null) path = nil;
        return $scope.get('Pathname').$new(path)}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($c);
        self.stats = $hash2([], {});
        self.entries = $hash2([], {});
        return self.patterns = $hash2([], {});
      }, TMP_3.$$arity = 4);

      Opal.defn(self, '$root', TMP_4 = function ːroot() {
        var self = this;
      ...
      Opal.defn(self, '$find', TMP_6 = function ːfind($a_rest) {try {

        var $b, $c, TMP_7, $d, TMP_8, self = this, logical_paths, $iter = TMP_6.$$p, block = $iter || nil, options = nil, base_path = nil;

        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        logical_paths = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
          logical_paths[$arg_idx - 0] = arguments[$arg_idx];
        }
        TMP_6.$$p = null;
        if ((block !== nil)) {
          options = self['$extract_options!'](logical_paths);
          base_path = $scope.get('Pathname').$new(((($b = options['$[]']("base_path")) !== false && $b !== nil && $b != null) ? $b : self.root));
          ($b = ($c = logical_paths).$each, $b.$$p = (TMP_7 = function(logical_path){var self = TMP_7.$$s || this, $a, $d, $e;
if (logical_path == null) logical_path = nil;
          logical_path = $scope.get('Pathname').$new(logical_path.$sub(/^\//, ""));
            if ((($a = self['$relative?'](logical_path)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
              return ($a = ($d = self).$find_in_base_path, $a.$$p = block.$to_proc(), $a).call($d, logical_path, base_path)
              } else {
              return ($a = ($e = self).$find_in_paths, $a.$$p = block.$to_proc(), $a).call($e, logical_path)
            };}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $b).call($c);
          return nil;
          } else {
          return ($b = ($d = self).$find, $b.$$p = (TMP_8 = function(path){var self = TMP_8.$$s || this;
if (path == null) path = nil;
          Opal.ret(path)}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $b).apply($d, Opal.to_a(logical_paths))
        };
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      }, TMP_6.$$arity = -1);

      Opal.defn(self, '$entries', TMP_10 = function ːentries(path) {
        var $a, $b, $c, $d, $e, TMP_9, self = this, pathname = nil;

        return ($a = path.$to_s(), $b = self.entries, ((($c = $b['$[]']($a)) !== false && $c !== nil && $c != null) ? $c : $b['$[]=']($a, (function() {pathname = $scope.get('Pathname').$new(path);
        if ((($d = pathname['$directory?']()) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
          return ($d = ($e = pathname.$entries()).$reject, $d.$$p = (TMP_9 = function(entry){var self = TMP_9.$$s || this;
if (entry == null) entry = nil;
          return entry.$to_s()['$=~'](/^\.|~$|^\#.*\#$/)}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9), $d).call($e).$sort()
          } else {
          return []
        };})())));
      }, TMP_10.$$arity = 1);

      Opal.defn(self, '$stat', TMP_11 = function ːstat(path) {
        var $a, self = this, key = nil;

        key = path.$to_s();
        if ((($a = self.stats['$key?'](key)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.stats['$[]'](key)
        } else if ((($a = $scope.get('File')['$exist?'](path)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.stats['$[]='](key, $scope.get('File').$stat(path))
          } else {
          return self.stats['$[]='](key, nil)
        };
      }, TMP_11.$$arity = 1);

      self.$protected();

      Opal.defn(self, '$extract_options!', TMP_12 = function(arguments$) {
        var $a, self = this;

        if ((($a = arguments$.$last()['$is_a?']($scope.get('Hash'))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$relative?', TMP_13 = function(logical_path) {
        var self = this;

        return logical_path.$to_s()['$=~'](/^\.\.?\//);
      }, TMP_13.$$arity = 1);

      Opal.defn(self, '$find_in_paths', TMP_14 = function ːfind_in_paths(logical_path) {
        var $a, $b, TMP_15, self = this, $iter = TMP_14.$$p, block = $iter || nil, dirname = nil, basename = nil;

        TMP_14.$$p = null;
        $b = logical_path.$split(), $a = Opal.to_ary($b), dirname = ($a[0] == null ? nil : $a[0]), basename = ($a[1] == null ? nil : $a[1]), $b;
        return ($a = ($b = self.pathnames).$each, $a.$$p = (TMP_15 = function(base_path){var self = TMP_15.$$s || this, $c, $d;
if (base_path == null) base_path = nil;
        return ($c = ($d = self).$match, $c.$$p = block.$to_proc(), $c).call($d, base_path.$join(dirname), basename)}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15), $a).call($b);
      }, TMP_14.$$arity = 1);

      Opal.defn(self, '$find_in_base_path', TMP_16 = function ːfind_in_base_path(logical_path, base_path) {
        var $a, $b, self = this, $iter = TMP_16.$$p, block = $iter || nil, candidate = nil, dirname = nil, basename = nil;
        ...
        if ((($a = self['$paths_contain?'](dirname)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return ($a = ($b = self).$match, $a.$$p = block.$to_proc(), $a).call($b, dirname, basename)
          } else {
          return nil
        };
      }, TMP_16.$$arity = 2);

      Opal.defn(self, '$match', TMP_19 = function ːmatch(dirname, basename) {
        var $a, $b, TMP_17, $c, TMP_18, self = this, $iter = TMP_19.$$p, $yield = $iter || nil, matches = nil, pattern = nil;

        TMP_19.$$p = null;
        matches = self.$entries(dirname);
        pattern = self.$pattern_for(basename);
        matches = ($a = ($b = matches).$select, $a.$$p = (TMP_17 = function(m){var self = TMP_17.$$s || this;
if (m == null) m = nil;
        return m.$to_s()['$=~'](pattern)}, TMP_17.$$s = self, TMP_17.$$arity = 1, TMP_17), $a).call($b);
        return ($a = ($c = self.$sort_matches(matches, basename)).$each, $a.$$p = (TMP_18 = function(path){var self = TMP_18.$$s || this, $d, $e, pathname = nil, stat = nil;
if (path == null) path = nil;
        pathname = dirname.$join(path);
          stat = self.$stat(pathname);
          if ((($d = (($e = stat !== false && stat !== nil && stat != null) ? stat['$file?']() : stat)) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
            return Opal.yield1($yield, pathname.$to_s());
            } else {
            return nil
          };}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $a).call($c);
      }, TMP_19.$$arity = 2);

      Opal.defn(self, '$paths_contain?', TMP_21 = function(dirname) {
        var $a, $b, TMP_20, self = this;

        return ($a = ($b = self.$paths())['$any?'], $a.$$p = (TMP_20 = function(path){var self = TMP_20.$$s || this;
if (path == null) path = nil;
        return dirname.$to_s()['$[]'](0, path.$length())['$=='](path)}, TMP_20.$$s = self, TMP_20.$$arity = 1, TMP_20), $a).call($b);
      }, TMP_21.$$arity = 1);

      Opal.defn(self, '$pattern_for', TMP_22 = function ːpattern_for(basename) {
        var $a, $b, $c, self = this;

        return ($a = basename, $b = self.patterns, ((($c = $b['$[]']($a)) !== false && $c !== nil && $c != null) ? $c : $b['$[]=']($a, self.$build_pattern_for(basename))));
      }, TMP_22.$$arity = 1);

      Opal.defn(self, '$build_pattern_for', TMP_25 = function ːbuild_pattern_for(basename) {
        var $a, $b, TMP_23, $c, TMP_24, self = this, extname = nil, aliases = nil, aliases_pattern = nil, basename_re = nil, extension_pattern = nil;

        extname = basename.$extname();
        aliases = self.$find_aliases_for(extname);
        if ((($a = aliases['$any?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          basename = basename.$basename(extname);
          aliases = $rb_plus([extname], aliases);
          aliases_pattern = ($a = ($b = aliases).$map, $a.$$p = (TMP_23 = function(e){var self = TMP_23.$$s || this;
if (e == null) e = nil;
          return $scope.get('Regexp').$escape(e)}, TMP_23.$$s = self, TMP_23.$$arity = 1, TMP_23), $a).call($b).$join("|");
          basename_re = $rb_plus($scope.get('Regexp').$escape(basename.$to_s()), "(?:" + (aliases_pattern) + ")");
          } else {
          basename_re = $scope.get('Regexp').$escape(basename.$to_s())
        };
        extension_pattern = ($a = ($c = self.$extensions()).$map, $a.$$p = (TMP_24 = function(e){var self = TMP_24.$$s || this;
if (e == null) e = nil;
        return $scope.get('Regexp').$escape(e)}, TMP_24.$$s = self, TMP_24.$$arity = 1, TMP_24), $a).call($c).$join("|");
        return (new RegExp("^" + basename_re + "(?:" + extension_pattern + ")*$"));
      }, TMP_25.$$arity = 1);

      Opal.defn(self, '$sort_matches', TMP_28 = function ːsort_matches(matches, basename) {
        var $a, $b, TMP_26, self = this, aliases = nil;

        aliases = self.$find_aliases_for(basename.$extname());
        return ($a = ($b = matches).$sort_by, $a.$$p = (TMP_26 = function(match){var self = TMP_26.$$s || this, $c, $d, TMP_27, extnames = nil;
if (match == null) match = nil;
        extnames = match.$sub(basename.$to_s(), "").$to_s().$scan(/\.[^.]+/);
          return ($c = ($d = extnames).$inject, $c.$$p = (TMP_27 = function(sum, ext){var self = TMP_27.$$s || this, $e, i = nil;
if (sum == null) sum = nil;if (ext == null) ext = nil;
          if ((($e = i = self.$extensions().$index(ext)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
              return $rb_plus($rb_plus(sum, i), 1)
            } else if ((($e = i = aliases.$index(ext)) !== nil && $e != null && (!$e.$$is_boolean || $e == true))) {
              return $rb_plus($rb_plus(sum, i), 11)
              } else {
              return sum
            }}, TMP_27.$$s = self, TMP_27.$$arity = 2, TMP_27), $c).call($d, 0);}, TMP_26.$$s = self, TMP_26.$$arity = 1, TMP_26), $a).call($b);
      }, TMP_28.$$arity = 2);

      return (Opal.defn(self, '$find_aliases_for', TMP_30 = function ːfind_aliases_for(extension) {
        var $a, $b, TMP_29, self = this;

        return ($a = ($b = self.aliases).$inject, $a.$$p = (TMP_29 = function(aliases, $c){var self = TMP_29.$$s || this, $c_args, key, value;
          ...
          value = $c_args.splice(0,1)[0];
          if (value == null) {
            value = nil;
          }if (aliases == null) aliases = nil;
        if (value['$=='](extension)) {
            aliases.$push(key)};
          return aliases;}, TMP_29.$$s = self, TMP_29.$$arity = 2, TMP_29.$$has_top_level_mlhs_arg = true, TMP_29), $a).call($b, []);
      }, TMP_30.$$arity = 1), nil) && 'find_aliases_for';
    })($scope.base, null)
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
Opal.modules["hike/paths"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$new', '$relative?', '$join', '$to_s', '$expand_path']);
  self.$require("pathname");
  self.$require("hike/normalized_array");
  return (function($base) {
    var $Hike, self = $Hike = $module($base, 'Hike');
    ...
    (function($base, $super) {
      ...
      def.root = nil;
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(root) {
        var $a, $b, self = this, $iter = TMP_1.$$p, $yield = $iter || nil;
        ...
        TMP_1.$$p = null;
        self.root = $scope.get('Pathname').$new(root);
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_1, false)), $a.$$p = null, $a).call($b);
      }, TMP_1.$$arity = -1);

      return (Opal.defn(self, '$normalize_element', TMP_2 = function ːnormalize_element(path) {
        var $a, self = this;

        path = $scope.get('Pathname').$new(path);
        if ((($a = path['$relative?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          path = self.root.$join(path)};
        return path.$expand_path().$to_s();
      }, TMP_2.$$arity = 1), nil) && 'normalize_element';
    })($scope.base, $scope.get('NormalizedArray'))
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
Opal.modules["hike/trail"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$attr_reader', '$expand_path', '$new', '$[]=', '$to_s', '$unshift', '$paths', '$alias_method', '$push', '$delete', '$extensions', '$aliases', '$normalize_extension', '$find', '$to_proc', '$index', '$root', '$directory?', '$sort', '$reject', '$=~', '$entries', '$exist?', '$stat', '$private', '$[]']);
  self.$require("pathname");
  self.$require("hike/extensions");
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12, TMP_13, TMP_15, TMP_16, TMP_17;
      ...
      Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(root) {
        var $a, $b, TMP_1, self = this;

        if (root == null) {
          root = ".";
        }
        self.root = $scope.get('Pathname').$new(root).$expand_path();
        self.paths = $scope.get('Paths').$new(self.root);
        self.extensions = $scope.get('Extensions').$new();
        return self.aliases = ($a = ($b = $scope.get('Hash')).$new, $a.$$p = (TMP_1 = function(h, k){var self = TMP_1.$$s || this;
if (h == null) h = nil;if (k == null) k = nil;
        return h['$[]='](k, $scope.get('Extensions').$new())}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), $a).call($b);
      }, TMP_2.$$arity = -1);

      Opal.defn(self, '$root', TMP_3 = function ːroot() {
        var self = this;

        return self.root.$to_s();
      }, TMP_3.$$arity = 0);

      Opal.defn(self, '$prepend_paths', TMP_4 = function ːprepend_paths($a_rest) {
        var $b, self = this, paths;
        ...
        return ($b = self.$paths()).$unshift.apply($b, Opal.to_a(paths));
      }, TMP_4.$$arity = -1);

      self.$alias_method("prepend_path", "prepend_paths");

      Opal.defn(self, '$append_paths', TMP_5 = function ːappend_paths($a_rest) {
        var $b, self = this, paths;
        ...
        return ($b = self.$paths()).$push.apply($b, Opal.to_a(paths));
      }, TMP_5.$$arity = -1);

      self.$alias_method("append_path", "append_paths");

      Opal.defn(self, '$remove_path', TMP_6 = function ːremove_path(path) {
        var self = this;

        return self.$paths().$delete(path);
      }, TMP_6.$$arity = 1);

      Opal.defn(self, '$prepend_extensions', TMP_7 = function ːprepend_extensions($a_rest) {
        var $b, self = this, extensions;

        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        extensions = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
          extensions[$arg_idx - 0] = arguments[$arg_idx];
        }
        return ($b = self.$extensions()).$unshift.apply($b, Opal.to_a(extensions));
      }, TMP_7.$$arity = -1);

      self.$alias_method("prepend_extension", "prepend_extensions");

      Opal.defn(self, '$append_extensions', TMP_8 = function ːappend_extensions($a_rest) {
        var $b, self = this, extensions;
        ...
        return ($b = self.$extensions()).$push.apply($b, Opal.to_a(extensions));
      }, TMP_8.$$arity = -1);

      self.$alias_method("append_extension", "append_extensions");

      Opal.defn(self, '$remove_extension', TMP_9 = function ːremove_extension(extension) {
        var self = this;

        return self.$extensions().$delete(extension);
      }, TMP_9.$$arity = 1);

      Opal.defn(self, '$alias_extension', TMP_10 = function ːalias_extension(new_extension, old_extension) {
        var self = this;

        return self.$aliases()['$[]='](self.$normalize_extension(new_extension), self.$normalize_extension(old_extension));
      }, TMP_10.$$arity = 2);

      Opal.defn(self, '$unalias_extension', TMP_11 = function ːunalias_extension(extension) {
        var self = this;

        return self.$aliases().$delete(self.$normalize_extension(extension));
      }, TMP_11.$$arity = 1);

      Opal.defn(self, '$find', TMP_12 = function ːfind($a_rest) {
        ...
        TMP_12.$$p = null;
        return ($b = ($c = self.$index()).$find, $b.$$p = block.$to_proc(), $b).apply($c, Opal.to_a(args));
      }, TMP_12.$$arity = -1);

      Opal.defn(self, '$index', TMP_13 = function ːindex() {
        var self = this;

        return $scope.get('Index').$new(self.$root(), self.$paths(), self.$extensions(), self.$aliases());
      }, TMP_13.$$arity = 0);

      Opal.defn(self, '$entries', TMP_15 = function ːentries(path) {
        var $a, $b, TMP_14, self = this, pathname = nil;

        pathname = $scope.get('Pathname').$new(path);
        if ((($a = pathname['$directory?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return ($a = ($b = pathname.$entries()).$reject, $a.$$p = (TMP_14 = function(entry){var self = TMP_14.$$s || this;
if (entry == null) entry = nil;
          return entry.$to_s()['$=~'](/^\.|~$|^\#.*\#$/)}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $a).call($b).$sort()
          } else {
          return []
        };
      }, TMP_15.$$arity = 1);

      Opal.defn(self, '$stat', TMP_16 = function ːstat(path) {
        var $a, self = this;

        if ((($a = $scope.get('File')['$exist?'](path)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return $scope.get('File').$stat(path.$to_s())
          } else {
          return nil
        };
      }, TMP_16.$$arity = 1);
      ...
      return (Opal.defn(self, '$normalize_extension', TMP_17 = function ːnormalize_extension(extension) {
        var $a, self = this;
      ...
      }, TMP_17.$$arity = 1), nil) && 'normalize_extension';
    })($scope.base, null)
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
Opal.modules["hike"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
  ...
  return (function($base) {
    ...
    self.$autoload("Extensions", "hike/extensions");

    self.$autoload("Index", "hike/index");

    self.$autoload("NormalizedArray", "hike/normalized_array");

    self.$autoload("Paths", "hike/paths");

    self.$autoload("Trail", "hike/trail");
  })($scope.base)
};
/* Generated by Opal 0.10.0 */
Opal.modules["opal/hike_path_finder"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $klass = Opal.klass;

  Opal.add_stubs(['$require', '$append_paths', '$append_extensions', '$paths', '$Pathname', '$absolute?', '$exist?']);
  self.$require("hike");
  self.$require("pathname");
  return (function($base) {
    ...
    (function($base, $super) {
      function $HikePathFinder(){};
      var self = $HikePathFinder = $klass($base, $super, 'HikePathFinder', $HikePathFinder);

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2;

      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(paths) {
        var $a, $b, self = this, $iter = TMP_1.$$p, $yield = $iter || nil;

        if (paths == null) {
          paths = $scope.get('Opal').$paths();
        }
        TMP_1.$$p = null;
        ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize', TMP_1, false)), $a.$$p = null, $a).call($b);
        ($a = self).$append_paths.apply($a, Opal.to_a(paths));
        return self.$append_extensions(".js", ".js.rb", ".rb", ".opalerb");
      }, TMP_1.$$arity = -1);

      return (Opal.defn(self, '$find', TMP_2 = function ːfind(path) {
        var $a, $b, self = this, $iter = TMP_2.$$p, $yield = $iter || nil, pathname = nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
        ...
        if ((($a = ($b = pathname['$absolute?'](), $b !== false && $b !== nil && $b != null ?pathname['$exist?']() : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return path};
        return ($a = ($b = self, Opal.find_super_dispatcher(self, 'find', TMP_2, false)), $a.$$p = $iter, $a).apply($b, $zuper);
      }, TMP_2.$$arity = 1), nil) && 'find';
    })($scope.base, (($scope.get('Hike')).$$scope.get('Trail')))
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
Opal.modules["opal/path_reader"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$new', '$expand', '$nil?', '$open', '$read', '$absolute?', '$=~', '$find', '$file_finder', '$paths', '$append_paths', '$private', '$attr_reader']);
  self.$require("opal/hike_path_finder");
  return (function($base) {
    var $Opal, self = $Opal = $module($base, 'Opal');
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_3, TMP_4, TMP_5, TMP_6;

      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(file_finder) {
        var self = this;

        if (file_finder == null) {
          file_finder = $scope.get('HikePathFinder').$new();
        }
        return self.file_finder = file_finder;
      }, TMP_1.$$arity = -1);

      Opal.defn(self, '$read', TMP_3 = function ːread(path) {
        var $a, $b, TMP_2, self = this, full_path = nil;

        full_path = self.$expand(path);
        if ((($a = full_path['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil};
        return ($a = ($b = $scope.get('File')).$open, $a.$$p = (TMP_2 = function(f){var self = TMP_2.$$s || this;
if (f == null) f = nil;
        return f.$read()}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2), $a).call($b, full_path, "rb:UTF-8");
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$expand', TMP_4 = function ːexpand(path) {
        var $a, $b, self = this;

        if ((($a = ((($b = $scope.get('Pathname').$new(path)['$absolute?']()) !== false && $b !== nil && $b != null) ? $b : path['$=~']((new RegExp("\\A\\.?\\." + (($scope.get('File')).$$scope.get('SEPARATOR'))))))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return path
          } else {
      ...
      Opal.defn(self, '$paths', TMP_5 = function ːpaths() {
        var self = this;

        return self.$file_finder().$paths();
      }, TMP_5.$$arity = 0);

      Opal.defn(self, '$append_paths', TMP_6 = function ːappend_paths($a_rest) {
        var $b, self = this, paths;
        ...
        return ($b = self.$file_finder()).$append_paths.apply($b, Opal.to_a(paths));
      }, TMP_6.$$arity = -1);
...
Opal.modules["source_map/offset"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(line, column) {
        var $a, self = this;
      ...
      Opal.defn(self, '$to_s', TMP_5 = function ːto_s() {
        var self = this;
      ...
      return (Opal.defn(self, '$inspect', TMP_6 = function ːinspect() {
        var self = this;
...
Opal.modules["source_map/mapping"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$to_s', TMP_1 = function ːto_s() {
      ...
      return (Opal.defn(self, '$inspect', TMP_2 = function ːinspect() {
        var $a, self = this, str = nil;
...
if (h == null) h = nil;if (i == null) i = nil;
      ...
      Opal.defs(self, '$encode', TMP_4 = function ːencode(ary) {
...
if (n == null) n = nil;
      ...
      Opal.defs(self, '$decode', TMP_5 = function ːdecode(str) {
      ...
      Opal.defs(self, '$encode_mappings', TMP_8 = function ːencode_mappings(ary) {
...
if (segment == null) segment = nil;
      ...
      Opal.defs(self, '$decode_mappings', TMP_11 = function ːdecode_mappings(str) {
...
Opal.modules["source_map/map"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defs(self, '$from_json', TMP_1 = function ːfrom_json(json) {
        var self = this;

        return self.$from_hash($scope.get('JSON').$parse(json));
      }, TMP_1.$$arity = 1);

      Opal.defs(self, '$from_hash', TMP_2 = function ːfrom_hash(hash) {
      ...
      Opal.defs(self, '$decode_vlq_mappings', TMP_5 = function ːdecode_vlq_mappings(str, sources, names) {
...
if (segment == null) segment = nil;
      ...
      Opal.defn(self, '$initialize', TMP_6 = function ːinitialize(mappings, filename) {
        var $a, self = this;
      ...
      Opal.defn(self, '$size', TMP_7 = function ːsize() {
        var self = this;
      ...
      Opal.defn(self, '$each', TMP_9 = function ːeach() {
...
if (m == null) m = nil;
      ...
      Opal.defn(self, '$bsearch', TMP_19 = function ːbsearch(offset, from, to) {
      ...
      Opal.defn(self, '$as_json', TMP_20 = function ːas_json() {
        var self = this;
      ...
      Opal.defn(self, '$inspect', TMP_21 = function ːinspect() {
      ...
      return (Opal.defn(self, '$build_vlq_string', TMP_25 = function ːbuild_vlq_string() {
...
Opal.modules["opal/builder_processors"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$<<', '$attr_reader', '$to_s', '$source', '$join', '$==', '$size', '$new', '$is_a?', '$match', '$match_regexp', '$raise', '$+', '$filename', '$count', '$scan', '$any?', '$inspect', '$handles', '$mark_as_required', '$result', '$compiled', '$map', '$source_map', '$compiler_for', '$gsub', '$compile', '$compiler_class', '$merge', '$requires', '$sub', '$dirname', '$required_trees', '$prepare', '$private', '$erb_compiler_class', '$prepared_source']);
  self.$require("opal/compiler");
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.cdecl($scope, 'DEFAULT_PROCESSORS', []);
      ...
      (function($base, $super) {
        ...
        def.source_map = nil;
        Opal.defs(self, '$inherited', TMP_1 = function ːinherited(processor) {
          var self = this;

          return $scope.get('DEFAULT_PROCESSORS')['$<<'](processor);
        }, TMP_1.$$arity = 1);

        Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(source, filename, options) {
          var $a, self = this;
        ...
        Opal.defs(self, '$handles', TMP_4 = function ːhandles($a_rest) {
          var self = this, extensions, matches = nil;
          ...
          if (extensions.$size()['$=='](1)) {
            matches = "(" + (matches) + ")"};
          return self.match_regexp = $scope.get('Regexp').$new("\\." + (matches) + ($scope.get('REGEXP_END')));
        }, TMP_4.$$arity = -1);

        Opal.defs(self, '$extensions', TMP_5 = function ːextensions() {
          var self = this;
        ...
        Opal.defs(self, '$match?', TMP_6 = function(other) {
          var $a, self = this;

          return (($a = other['$is_a?']($scope.get('String')), $a !== false && $a !== nil && $a != null ?other.$match(self.$match_regexp()) : $a));
        }, TMP_6.$$arity = 1);

        Opal.defs(self, '$match_regexp', TMP_7 = function ːmatch_regexp() {
          var $a, self = this;
          if (self.match_regexp == null) self.match_regexp = nil;

          return ((($a = self.match_regexp) !== false && $a !== nil && $a != null) ? $a : self.$raise($scope.get('NotImplementedError')));
        }, TMP_7.$$arity = 0);

        Opal.defn(self, '$source_map', TMP_8 = function ːsource_map() {
          var $a, $b, self = this, mappings = nil, source_file = nil, line = nil, column = nil, offset = nil, zero_offset = nil;

          return ((($a = self.source_map) !== false && $a !== nil && $a != null) ? $a : self.source_map = (function() {mappings = [];
          source_file = $rb_plus(self.$filename(), ".js");
          line = self.$source().$count("\n");
          column = self.$source().$scan("\n[^\n]*$").$size();
          offset = ((Opal.get('SourceMap')).$$scope.get('Offset')).$new(line, column);
          mappings['$<<'](((Opal.get('SourceMap')).$$scope.get('Mapping')).$new(source_file, offset, offset));
          ...
          return ((Opal.get('SourceMap')).$$scope.get('Map')).$new(mappings);})());
        }, TMP_8.$$arity = 0);

        return (Opal.defn(self, '$mark_as_required', TMP_9 = function ːmark_as_required(filename) {
          var self = this;

          return "Opal.loaded([" + (filename.$to_s().$inspect()) + "]);";
        }, TMP_9.$$arity = 1), nil) && 'mark_as_required';
      })($scope.base, null);
      ...
      (function($base, $super) {
        ...
        return (Opal.defn(self, '$source', TMP_10 = function ːsource() {
          var self = this;

          return $rb_plus(self.source.$to_s(), self.$mark_as_required(self.filename));
        }, TMP_10.$$arity = 0), nil) && 'source';
      ...
      (function($base, $super) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_11, TMP_12, TMP_13, TMP_14, TMP_15, TMP_17, TMP_18;

        def.compiled = def.source = def.filename = def.options = nil;
        self.$handles("rb", "opal");

        Opal.defn(self, '$source', TMP_11 = function ːsource() {
          var self = this;

          return self.$compiled().$result();
        }, TMP_11.$$arity = 0);

        Opal.defn(self, '$source_map', TMP_12 = function ːsource_map() {
          var self = this;

          return self.$compiled().$source_map().$map();
        }, TMP_12.$$arity = 0);

        Opal.defn(self, '$compiled', TMP_13 = function ːcompiled() {
          var $a, self = this, compiler = nil;

          return ((($a = self.compiled) !== false && $a !== nil && $a != null) ? $a : self.compiled = (function() {compiler = self.$compiler_for(self.source, $hash2(["file"], {"file": self.filename.$gsub((new RegExp("\\.(rb|js|opal)" + $scope.get('REGEXP_END'))), "")}));
          compiler.$compile();
          return compiler;})());
        }, TMP_13.$$arity = 0);

        Opal.defn(self, '$compiler_for', TMP_14 = function ːcompiler_for(source, options) {
          var self = this;

          if (options == null) {
            options = $hash2([], {});
          }
          return self.$compiler_class().$new(source, self.options.$merge(options));
        }, TMP_14.$$arity = -2);

        Opal.defn(self, '$requires', TMP_15 = function ːrequires() {
          var self = this;

          return self.$compiled().$requires();
        }, TMP_15.$$arity = 0);

        Opal.defn(self, '$required_trees', TMP_17 = function ːrequired_trees() {
          var $a, $b, TMP_16, self = this;

          return ($a = ($b = self.$compiled().$required_trees()).$map, $a.$$p = (TMP_16 = function(tree){var self = TMP_16.$$s || this;
            if (self.filename == null) self.filename = nil;
if (tree == null) tree = nil;
          return $scope.get('File').$join($scope.get('File').$dirname(self.filename), tree).$sub(/^(\.\/)*/, "")}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $a).call($b);
        }, TMP_17.$$arity = 0);

        return (Opal.defn(self, '$compiler_class', TMP_18 = function ːcompiler_class() {
          var self = this;

          return ((Opal.get('Opal')).$$scope.get('Compiler'));
        }, TMP_18.$$arity = 0), nil) && 'compiler_class';
      })($scope.base, $scope.get('Processor'));
      ...
      (function($base, $super) {
        ...
        var def = self.$$proto, $scope = self.$$scope, TMP_19, TMP_20, TMP_21, TMP_22;

        def.source = def.filename = nil;
        self.$handles("opalerb");

        Opal.defn(self, '$initialize', TMP_19 = function ːinitialize($a_rest) {
          var $b, $c, self = this, args, $iter = TMP_19.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil, $zuper_length = nil;
          ...
          ($b = ($c = self, Opal.find_super_dispatcher(self, 'initialize', TMP_19, false)), $b.$$p = $iter, $b).apply($c, $zuper);
          return self.source = self.$prepare(self.source, self.filename);
        }, TMP_19.$$arity = -1);

        Opal.defn(self, '$requires', TMP_20 = function ːrequires() {
          ...
          return $rb_plus(["erb"], ($a = ($b = self, Opal.find_super_dispatcher(self, 'requires', TMP_20, false)), $a.$$p = $iter, $a).apply($b, $zuper));
        }, TMP_20.$$arity = 0);

        self.$private();

        Opal.defn(self, '$erb_compiler_class', TMP_21 = function ːerb_compiler_class() {
          var self = this;

          return ((((Opal.get('Opal')).$$scope.get('ERB'))).$$scope.get('Compiler'));
        }, TMP_21.$$arity = 0);

        return (Opal.defn(self, '$prepare', TMP_22 = function ːprepare(source, path) {
          var self = this, erb_compiler = nil;

          erb_compiler = self.$erb_compiler_class().$new(source, path);
          return erb_compiler.$prepared_source();
        }, TMP_22.$$arity = 2), nil) && 'prepare';
      })($scope.base, $scope.get('RubyProcessor'));
      ...
      (function($base, $super) {
        ...
        return (Opal.defn(self, '$source', TMP_23 = function ːsource() {
          var self = this, result = nil;

          result = Opal.get('ERB').$new(self.source.$to_s()).$result();
          return "Opal.modules[" + (self.filename.$inspect()) + "] = function() {" + (result) + "};";
        }, TMP_23.$$arity = 0), nil) && 'source';
      })($scope.base, $scope.get('Processor'));
    })($scope.base)
  })($scope.base);
};
...
Opal.modules["opal/paths"] = function(Opal) {
  ...
  Opal.add_stubs(['$expand_path', '$untaint', '$append_paths', '$concat', '$require_paths_for_gem', '$private', '$find_by_name', '$raise', '$each', '$+', '$name', '$runtime_dependencies', '$gem_dir', '$map', '$<<', '$join', '$require_paths', '$extend', '$freeze', '$dup', '$core_dir', '$std_dir', '$reset_paths!']);
  return (function($base) {
    var $Opal, self = $Opal = $module($base, 'Opal');

    var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_10, TMP_11;

    Opal.defs(self, '$gem_dir', TMP_1 = function ːgem_dir() {
      var self = this;

      return $scope.get('File').$expand_path("../..", "opal/paths".$untaint());
    }, TMP_1.$$arity = 0);

    Opal.defs(self, '$core_dir', TMP_2 = function ːcore_dir() {
      var self = this;

      return $scope.get('File').$expand_path("../../../opal", "opal/paths".$untaint());
    }, TMP_2.$$arity = 0);

    Opal.defs(self, '$std_dir', TMP_3 = function ːstd_dir() {
      var self = this;

      return $scope.get('File').$expand_path("../../../stdlib", "opal/paths".$untaint());
    }, TMP_3.$$arity = 0);

    Opal.defs(self, '$append_path', TMP_4 = function ːappend_path(path) {
      var self = this;

      return self.$append_paths(path);
    }, TMP_4.$$arity = 1);

    Opal.defs(self, '$append_paths', TMP_5 = function ːappend_paths($a_rest) {
      var self = this, paths;
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_6, TMP_9;

      Opal.defn(self, '$use_gem', TMP_6 = function ːuse_gem(gem_name, include_dependencies) {
        var $a, self = this;

        if (include_dependencies == null) {
          include_dependencies = true;
        }
        return ($a = self).$append_paths.apply($a, Opal.to_a(self.$require_paths_for_gem(gem_name, include_dependencies)));
      }, TMP_6.$$arity = -2);

      self.$private();

      Opal.defn(self, '$require_paths_for_gem', TMP_9 = function ːrequire_paths_for_gem(gem_name, include_dependencies) {
        var $a, $b, TMP_7, $c, TMP_8, self = this, paths = nil, spec = nil, gem_dir = nil;

        paths = [];
        spec = (($scope.get('Gem')).$$scope.get('Specification')).$find_by_name(gem_name);
        if (spec !== false && spec !== nil && spec != null) {
          } else {
          self.$raise($scope.get('GemNotFound'), gem_name)
        };
        if (include_dependencies !== false && include_dependencies !== nil && include_dependencies != null) {
          ($a = ($b = spec.$runtime_dependencies()).$each, $a.$$p = (TMP_7 = function(dependency){var self = TMP_7.$$s || this;
if (dependency == null) dependency = nil;
          return paths = $rb_plus(paths, self.$require_paths_for_gem(dependency.$name(), include_dependencies))}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7), $a).call($b)};
        gem_dir = spec.$gem_dir();
        ($a = ($c = spec.$require_paths()).$map, $a.$$p = (TMP_8 = function(path){var self = TMP_8.$$s || this;
if (path == null) path = nil;
        return paths['$<<']($scope.get('File').$join(gem_dir, path))}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8), $a).call($c);
        return paths;
      }, TMP_9.$$arity = 2);
    })($scope.base);

    self.$extend($scope.get('UseGem'));

    Opal.defs(self, '$paths', TMP_10 = function ːpaths() {
      var self = this;
      if (self.paths == null) self.paths = nil;
    ...
    Opal.defs(self, '$reset_paths!', TMP_11 = function() {
      var self = this;
...
Opal.modules["opal/builder"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$each_pair', '$public_send', '$new', '$build', '$to_proc', '$read', '$build_str', '$stub?', '$to_s', '$expand', '$path_reader', '$processor_for', '$+', '$preload', '$requires', '$tree_requires', '$map', '$process_require', '$<<', '$processed', '$raise', '$inspect', '$message', '$backtrace', '$dup', '$stubs', '$processors', '$prerequired', '$compiler_options', '$join', '$to_json', '$as_json', '$reduce', '$append_paths', '$attr_reader', '$attr_accessor', '$private', '$nil?', '$empty?', '$pwd', '$dirname', '$expand_path', '$paths', '$flat_map', '$find', '$start_with?', '$extensions', '$gsub', '$relative_path_from', '$Pathname', '$[]', '$required_trees', '$match?', '$default_processor', '$merge', '$include?', '$already_processed', '$===', '$warn', '$process_requires', '$compact']);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_2, TMP_3, TMP_4, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_17, TMP_19, TMP_20, TMP_21, TMP_23, TMP_24, TMP_25, TMP_26;

      def.stubs = def.preload = def.processors = def.path_reader = def.prerequired = def.compiler_options = def.default_processor = def.already_processed = def.extensions = nil;
      self.$include($scope.get('BuilderProcessors'));
      ...
      (function($base, $super) {
        ...
        return nil;
      })($scope.base, $scope.get('LoadError'));

      Opal.defn(self, '$initialize', TMP_2 = function ːinitialize(options) {
        var $a, $b, TMP_1, $c, self = this;

        if (options == null) {
          options = nil;
        }
        ($a = ($b = (((($c = options) !== false && $c !== nil && $c != null) ? $c : $hash2([], {})))).$each_pair, $a.$$p = (TMP_1 = function(k, v){var self = TMP_1.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return self.$public_send("" + (k) + "=", v)}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), $a).call($b);
        ((($a = self.stubs) !== false && $a !== nil && $a != null) ? $a : self.stubs = []);
        ((($a = self.preload) !== false && $a !== nil && $a != null) ? $a : self.preload = []);
        ((($a = self.processors) !== false && $a !== nil && $a != null) ? $a : self.processors = $scope.get('DEFAULT_PROCESSORS'));
        ((($a = self.path_reader) !== false && $a !== nil && $a != null) ? $a : self.path_reader = $scope.get('PathReader').$new());
        ((($a = self.prerequired) !== false && $a !== nil && $a != null) ? $a : self.prerequired = []);
        ((($a = self.compiler_options) !== false && $a !== nil && $a != null) ? $a : self.compiler_options = $hash2([], {}));
        ((($a = self.default_processor) !== false && $a !== nil && $a != null) ? $a : self.default_processor = $scope.get('RubyProcessor'));
        return self.processed = [];
      }, TMP_2.$$arity = -1);

      Opal.defs(self, '$build', TMP_3 = function ːbuild($a_rest) {
        ...
        TMP_3.$$p = null;
        return ($b = ($c = self.$new()).$build, $b.$$p = block.$to_proc(), $b).apply($c, Opal.to_a(args));
      }, TMP_3.$$arity = -1);

      Opal.defn(self, '$build', TMP_4 = function ːbuild(path, options) {
        ...
        return self.$build_str(source, path, options);
      }, TMP_4.$$arity = -2);

      Opal.defn(self, '$build_str', TMP_6 = function ːbuild_str(source, filename, options) {
        var $a, $b, TMP_5, self = this, path = nil, asset = nil, requires = nil, error = nil;

        if (options == null) {
          options = $hash2([], {});
        }
        try {
          if ((($a = self['$stub?'](filename)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            } else {
            path = self.$path_reader().$expand(filename).$to_s()
          };
          asset = self.$processor_for(source, filename, path, options);
          requires = $rb_plus($rb_plus(self.$preload(), asset.$requires()), self.$tree_requires(asset, path));
          ($a = ($b = requires).$map, $a.$$p = (TMP_5 = function(r){var self = TMP_5.$$s || this;
if (r == null) r = nil;
          return self.$process_require(r, options)}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).call($b);
          self.$processed()['$<<'](asset);
          return self;
        } catch ($err) {
          if (Opal.rescue($err, [$scope.get('MissingRequire')])) {error = $err;
            try {
              return self.$raise(error, "A file required by " + (filename.$inspect()) + " wasn't found.\n" + (error.$message()), error.$backtrace())
            } finally { Opal.pop_exception() }
          } else { throw $err; }
        };
      }, TMP_6.$$arity = -3);

      Opal.defn(self, '$build_require', TMP_7 = function ːbuild_require(path, options) {
        var self = this;
      ...
      Opal.defn(self, '$initialize_copy', TMP_8 = function ːinitialize_copy(other) {
        ...
        ($a = ($b = self, Opal.find_super_dispatcher(self, 'initialize_copy', TMP_8, false)), $a.$$p = $iter, $a).apply($b, $zuper);
      ...
      Opal.defn(self, '$to_s', TMP_9 = function ːto_s() {
        var $a, $b, self = this;

        return ($a = ($b = self.$processed()).$map, $a.$$p = "to_s".$to_proc(), $a).call($b).$join("\n");
      }, TMP_9.$$arity = 0);

      Opal.defn(self, '$source_map', TMP_10 = function ːsource_map() {
        var $a, $b, self = this;

        return ($a = ($b = self.$processed()).$map, $a.$$p = "source_map".$to_proc(), $a).call($b).$reduce("+").$as_json().$to_json();
      }, TMP_10.$$arity = 0);

      Opal.defn(self, '$append_paths', TMP_11 = function ːappend_paths($a_rest) {
        var $b, self = this, paths;
        ...
        return ($b = self.$path_reader()).$append_paths.apply($b, Opal.to_a(paths));
      }, TMP_11.$$arity = -1);

      self.$include($scope.get('UseGem'));

      self.$attr_reader("processed");

      self.$attr_accessor("processors", "default_processor", "path_reader", "compiler_options", "stubs", "prerequired", "preload");

      self.$private();

      Opal.defn(self, '$tree_requires', TMP_17 = function ːtree_requires(asset, path) {
        var $a, $b, TMP_12, $c, TMP_13, self = this, dirname = nil, paths = nil;

        if ((($a = ((($b = path['$nil?']()) !== false && $b !== nil && $b != null) ? $b : path['$empty?']())) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          dirname = $scope.get('Dir').$pwd()
          } else {
          dirname = $scope.get('File').$dirname($scope.get('File').$expand_path(path))
        };
        paths = ($a = ($b = self.$path_reader().$paths()).$map, $a.$$p = (TMP_12 = function(p){var self = TMP_12.$$s || this;
if (p == null) p = nil;
        return $scope.get('File').$expand_path(p)}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12), $a).call($b);
        return ($a = ($c = asset.$required_trees()).$flat_map, $a.$$p = (TMP_13 = function(tree){var self = TMP_13.$$s || this, $d, $e, TMP_14, $f, TMP_15, $g, TMP_16, $h, expanded = nil, base = nil, globs = nil;
if (tree == null) tree = nil;
        expanded = $scope.get('File').$expand_path(tree, dirname);
          base = ($d = ($e = paths).$find, $d.$$p = (TMP_14 = function(p){var self = TMP_14.$$s || this;
if (p == null) p = nil;
          return expanded['$start_with?'](p)}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $d).call($e);
          if ((($d = base['$nil?']()) !== nil && $d != null && (!$d.$$is_boolean || $d == true))) {
            return [];};
          globs = ($d = ($f = self.$extensions()).$map, $d.$$p = (TMP_15 = function(ext){var self = TMP_15.$$s || this;
if (ext == null) ext = nil;
          return $scope.get('File').$join(base, tree, "**", "*." + (ext))}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15), $d).call($f);
          return ($d = ($g = ($h = $scope.get('Dir'))['$[]'].apply($h, Opal.to_a(globs))).$map, $d.$$p = (TMP_16 = function(file){var self = TMP_16.$$s || this;
if (file == null) file = nil;
          return self.$Pathname(file).$relative_path_from(self.$Pathname(base)).$to_s().$gsub((new RegExp("(\\.js)?(\\.(?:" + self.$extensions().$join("|") + "))" + $scope.get('REGEXP_END'))), "")}, TMP_16.$$s = self, TMP_16.$$arity = 1, TMP_16), $d).call($g);}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13), $a).call($c);
      }, TMP_17.$$arity = 2);

      Opal.defn(self, '$processor_for', TMP_19 = function ːprocessor_for(source, filename, path, options) {
        var $a, $b, TMP_18, self = this, processor = nil;

        processor = ($a = ($b = self.$processors()).$find, $a.$$p = (TMP_18 = function(p){var self = TMP_18.$$s || this;
if (p == null) p = nil;
        return p['$match?'](path)}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18), $a).call($b);
        ((($a = processor) !== false && $a !== nil && $a != null) ? $a : processor = self.$default_processor());
        return processor.$new(source, filename, self.$compiler_options().$merge(options));
      }, TMP_19.$$arity = 4);

      Opal.defn(self, '$read', TMP_20 = function ːread(path) {
        var $a, self = this;

        return ((($a = self.$path_reader().$read(path)) !== false && $a !== nil && $a != null) ? $a : self.$raise($scope.get('MissingRequire'), "can't find file: " + (path.$inspect()) + " in " + (self.$path_reader().$paths().$inspect())));
      }, TMP_20.$$arity = 1);

      Opal.defn(self, '$process_require', TMP_21 = function ːprocess_require(filename, options) {
        var $a, self = this, source = nil, message = nil, $case = nil, path = nil, asset = nil;

        filename = filename.$gsub((new RegExp("\\.(rb|js|opal)" + $scope.get('REGEXP_END'))), "");
        if ((($a = self.$prerequired()['$include?'](filename)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil};
        if ((($a = self.$already_processed()['$include?'](filename)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil};
        self.$already_processed()['$<<'](filename);
        source = (function() {if ((($a = self['$stub?'](filename)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return ""
          } else {
          return self.$read(filename)
        }; return nil; })();
        if ((($a = source['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          message = "can't find file: " + (filename.$inspect());
          $case = self.compiler_options['$[]']("dynamic_require_severity");if ("error"['$===']($case)) {self.$raise($scope.get('LoadError'), message)}else if ("warning"['$===']($case)) {self.$warn("can't find file: " + (filename.$inspect()))};};
        if ((($a = self['$stub?'](filename)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          path = self.$path_reader().$expand(filename).$to_s()
        };
        asset = self.$processor_for(source, filename, path, options.$merge($hash2(["requirable"], {"requirable": true})));
        self.$process_requires(filename, $rb_plus(asset.$requires(), self.$tree_requires(asset, path)), options);
        return self.$processed()['$<<'](asset);
      }, TMP_21.$$arity = 2);

      Opal.defn(self, '$process_requires', TMP_23 = function ːprocess_requires(filename, requires, options) {
        var $a, $b, TMP_22, self = this, error = nil;

        try {
          return ($a = ($b = requires).$map, $a.$$p = (TMP_22 = function(r){var self = TMP_22.$$s || this;
if (r == null) r = nil;
          return self.$process_require(r, options)}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22), $a).call($b)
        } catch ($err) {
          if (Opal.rescue($err, [$scope.get('MissingRequire')])) {error = $err;
            try {
              return self.$raise(error, "A file required by " + (filename.$inspect()) + " wasn't found.\n" + (error.$message()), error.$backtrace())
      ...
      Opal.defn(self, '$already_processed', TMP_24 = function ːalready_processed() {
        var $a, self = this;

        return ((($a = self.already_processed) !== false && $a !== nil && $a != null) ? $a : self.already_processed = $scope.get('Set').$new());
      }, TMP_24.$$arity = 0);

      Opal.defn(self, '$stub?', TMP_25 = function(filename) {
        var self = this;

        return self.$stubs()['$include?'](filename);
      }, TMP_25.$$arity = 1);

      return (Opal.defn(self, '$extensions', TMP_26 = function ːextensions() {
        var $a, $b, $c, self = this;

        return ((($a = self.extensions) !== false && $a !== nil && $a != null) ? $a : self.extensions = ($b = ($c = $scope.get('DEFAULT_PROCESSORS')).$flat_map, $b.$$p = "extensions".$to_proc(), $b).call($c).$compact());
      }, TMP_26.$$arity = 0), nil) && 'extensions';
    })($scope.base, null)
  })($scope.base);
};
/* Generated by Opal 0.10.0 */
