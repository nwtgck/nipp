...
Opal.modules["pp"] = function(Opal) {
  ...
  (function($base) {
    ...
    Opal.defn(self, '$pretty_inspect', TMP_1 = function ːpretty_inspect() {
      var self = this;

      return self.$inspect();
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$pp', TMP_3 = function ːpp($a_rest) {
  ...
  return (function($base, $super) {
    ...
    return (function(self) {
      ...
      if ((($a = (typeof(console) === "undefined" || typeof(console.log) === "undefined")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        Opal.defn(self, '$pp', TMP_4 = function ːpp(obj, out, width) {
          var $a, self = this;
        ...
        Opal.defn(self, '$pp', TMP_5 = function ːpp(obj, out, width) {
          var $a, self = this;
          if ($gvars.stdout == null) $gvars.stdout = nil;
