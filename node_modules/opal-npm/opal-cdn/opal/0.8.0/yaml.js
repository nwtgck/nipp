...
Opal.modules["nodejs/yaml"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$__fs__', '$native?', '$new']);
  self.$require("native");
  return (function($base) {
    var self = $module($base, 'YAML');

    var def = self.$$proto, $scope = self.$$scope;

    var __yaml__ = OpalNode.node_require('js-yaml');

    Opal.defs(self, '$load_path', function(path) {
      var $a, self = this, loaded = nil;

      loaded = __yaml__.yaml.safeLoad($scope.get('File').$__fs__().readFileSync(path, 'utf8'));
      if ((($a = self['$native?'](loaded)) !== nil && (!$a.$$is_boolean || $a == true))) {
...
Opal.modules["yaml"] = function(Opal) {
  ...
  if ((($a = ($scope.NodeJS != null)) !== nil && (!$a.$$is_boolean || $a == true))) {
