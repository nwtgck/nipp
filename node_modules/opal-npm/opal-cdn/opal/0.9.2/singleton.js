...
Opal.modules["singleton"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$clone', TMP_1 = function() {
      ...
      Opal.defn(self, '$inherited', TMP_2 = function(sub_klass) {
    ...
    (function(self) {
      ...
      return (Opal.defn(self, '$included', TMP_4 = function(klass) {
        var self = this, $iter = TMP_4.$$p, $yield = $iter || nil, $zuper = nil, $zuper_index = nil;
