...
Opal.modules["console"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$clear', TMP_1 = function $$clear() {
      var self = this;

      return self["native"].clear();
    }, TMP_1.$$arity = 0);

    Opal.defn(self, '$trace', TMP_2 = function $$trace() {
      var self = this;

      return self["native"].trace();
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$log', TMP_3 = function $$log($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$info', TMP_4 = function $$info($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$warn', TMP_5 = function $$warn($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$error', TMP_6 = function $$error($a_rest) {
      var self = this, args;
    ...
    Opal.defn(self, '$time', TMP_7 = function $$time(label) {
    ...
    Opal.defn(self, '$group', TMP_8 = function $$group($a_rest) {
