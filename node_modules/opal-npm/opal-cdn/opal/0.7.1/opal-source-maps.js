  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def['$+'] = function(other) {
        ...
        return (function() {$case = other;if ($scope.get('Offset')['$===']($case)) {return $scope.get('Offset').$new(self.$line()['$+'](other.$line()), self.$column()['$+'](other.$column()))}else if ($scope.get('Integer')['$===']($case)) {return $scope.get('Offset').$new(self.$line()['$+'](other), self.$column())}else {return self.$raise($scope.get('ArgumentError'), "can't convert " + (other) + " into " + (self.$class()))}})();
      };

      def['$<=>'] = function(other) {
        var $a, self = this, $case = nil, diff = nil;

        return (function() {$case = other;if ($scope.get('Offset')['$===']($case)) {diff = self.$line()['$-'](other.$line());
...
Opal.modules["source_map/vlq"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.cdecl($scope, 'VLQ_BASE_MASK', $scope.get('VLQ_BASE')['$-'](1));
...
if (n == null) n = nil;
      ...
      Opal.defs(self, '$decode', function(str) {
        ...
        vlq = vlq['$+'](digit['$<<'](shift));
        shift = shift['$+']($scope.get('VLQ_BASE_SHIFT'));};
...
if (segment == null) segment = nil;
          generated_column = generated_column['$+'](segment['$[]'](0));
            generated = $scope.get('Offset').$new(generated_line, generated_column);
            if (segment.$size()['$>='](4)) {
              source_id = source_id['$+'](segment['$[]'](1));
              original_line = original_line['$+'](segment['$[]'](2));
              original_column = original_column['$+'](segment['$[]'](3));
      ...
      def['$+'] = function(other) {
        ...
        offset = (function() {if ((($a = self.mappings['$any?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.mappings.$last().$generated().$line()['$+'](1)
          } else {
          return 0
        }; return nil; })();
        ($a = ($b = other).$each, $a.$$p = (TMP_4 = function(m){var self = TMP_4.$$s || this;
if (m == null) m = nil;
        return mappings['$<<']($scope.get('Mapping').$new(m.$source(), m.$generated()['$+'](offset), m.$original(), m.$name()))}, TMP_4.$$s = self, TMP_4), $a).call($b);
...
if (m == null) m = nil;
      ...
      def.$bsearch = function(offset, from, to) {
        ...
        if (offset['$=='](self['$[]'](mid).$generated())) {
          return self['$[]'](mid)
        } else if (offset['$<'](self['$[]'](mid).$generated())) {
          return self.$bsearch(offset, from, mid['$-'](1))
        } else if (offset['$>'](self['$[]'](mid).$generated())) {
          return self.$bsearch(offset, mid['$+'](1), to)
          } else {
          return nil
        };
      };
...
if (mapping == null) mapping = nil;
          group = [];
            ...
            if ((($a = mapping.$name()) !== nil && (!$a.$$is_boolean || $a == true))) {
              group['$<<'](names_index['$[]'](mapping.$name())['$-'](name_id))};
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$map = function() {
        ...
        return ((($a = self.map) !== false && $a !== nil) ? $a : self.map = (function() {source_file = self.$file()['$+'](".rb");
...
if (fragment == null) fragment = nil;
        mapping = nil;
          ...
          generated_line = generated_line['$+'](new_lines);
          if (new_lines['$>'](0)) {
            generated_column = source_code.$size()['$-']((source_code.$rindex("\n")['$+'](1)))
            } else {
            generated_column = generated_column['$+'](source_code.$size())
          };
...
//# sourceMappingURL=opal-source-maps.map
;
