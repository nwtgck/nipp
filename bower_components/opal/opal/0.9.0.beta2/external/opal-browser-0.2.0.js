...
Opal.modules["paggio/html"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function($base, $super) {
      ...
      Opal.defn(self, '$method_missing', TMP_5 = function(name) {var $zuper = $slice.call(arguments, 0);
...
if (sub == null) sub = nil;if (value == null) value = nil;
        ...
        Opal.defn(self, '$border', function() {
          var $a, $b, TMP_11, self = this, options = nil;
...
if (v == null) v = nil;
        ...
        Opal.defn(self, '$animation', function() {
          var $a, $b, TMP_18, self = this, options = nil;
...
if (name == null) name = nil;if (value == null) value = nil;
        ...
        Opal.defn(self, '$method_missing', TMP_19 = function(name) {
          var $a, $b, $c, TMP_20, self = this, $iter = TMP_19.$$p, block = $iter || nil, argument = nil;
...
if (name == null) name = nil;
      ...
      Opal.defn(self, '$media', TMP_6 = function(query) {
        var $a, self = this, $iter = TMP_6.$$p, block = $iter || nil, old = nil;
        ...
        TMP_6.$$p = null;
        if (block !== false && block !== nil) {
          $a = [self.media, query], old = $a[0], self.media = $a[1];
          block.$call();
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      return (function($base, $super) {
        ...
        return (Opal.defn(self, '$method_missing', TMP_2 = function(id) {var $zuper = $slice.call(arguments, 0);
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        Opal.defs(self, '$[]', function() {
          ...
          for(var arg_index = 0; arg_index < array_size; arg_index++) {
            nodes[arg_index] = arguments[arg_index + 0];
          }
...
if (el == null) el = nil;
        ...
        Opal.defn(self, '$at_css', function() {try {
          ...
          for(var arg_index = 0; arg_index < array_size; arg_index++) {
            rules[arg_index] = arguments[arg_index + 0];
          }
...
if (node == null) node = nil;
        ...
        Opal.defn(self, '$search', function() {
          ...
          for(var arg_index = 0; arg_index < array_size; arg_index++) {
            what[arg_index] = arguments[arg_index + 0];
          }
      ...
      (function($base, $super) {
        ...
        return (function($base, $super) {
          ...
          Opal.defn(self, '$initialize', function(element) {
            ...
            for(var arg_index = 0; arg_index < array_size; arg_index++) {
              inc[arg_index] = arguments[arg_index + 1];
            }
            self.element = element;
            self["native"] = element.$to_n();
...
if (path == null) path = nil;
    ...
    ;
        ...
        Opal.defn(self, '$search', function() {
          ...
          for(var arg_index = 0; arg_index < array_size; arg_index++) {
            selectors[arg_index] = arguments[arg_index + 0];
          }
...
if (selector == null) selector = nil;
        ...
        Opal.defn(self, '$size', function() {
          ...
          var inc = new Array(array_size);
          for(var arg_index = 0; arg_index < array_size; arg_index++) {
            inc[arg_index] = arguments[arg_index + 0];
          }
