...
Opal.modules["date"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defn(self, '$next_month', TMP_Date_next_month_36 = function $$next_month(n) {
      var self = this;
    ...
    }, TMP_Date_next_month_36.$$arity = -1);
    ...
    Opal.defn(self, '$prev_month', TMP_Date_prev_month_38 = function $$prev_month(n) {
      var self = this;
    ...
    Opal.defn(self, '$to_time', TMP_Date_to_time_44 = function $$to_time() {
      var self = this;

      return Opal.const_get_relative($nesting, 'Time').$new(self.$year(), self.$month(), self.$day())
    }, TMP_Date_to_time_44.$$arity = 0);
    
    Opal.defn(self, '$tuesday?', TMP_Date_tuesday$q_45 = function() {
      var self = this;

      return self.$wday()['$=='](2)
    }, TMP_Date_tuesday$q_45.$$arity = 0);
    
    Opal.defn(self, '$step', TMP_Date_step_46 = function $$step(limit, step) {
      var TMP_47, TMP_48, TMP_49, self = this, $iter = TMP_Date_step_46.$$p, block = $iter || nil, steps_count = nil, steps = nil, result = nil;

      if (step == null) {
        step = 1;
      }
      if ($iter) TMP_Date_step_46.$$p = null;
      
      steps_count = $rb_minus(limit, self).$to_i();
      if ($truthy($rb_lt($rb_times(steps_count, step), 0))) {
        steps = []
      } else if ($truthy($rb_lt(steps_count, 0))) {
        steps = $send(Opal.Range.$new(0, steps_count['$-@'](), false).$step(step.$abs()), 'map', [], (TMP_47 = function(i){var self = TMP_47.$$s || this;
if (i == null) i = nil;
        return i['$-@']()}, TMP_47.$$s = self, TMP_47.$$arity = 1, TMP_47)).$reverse()
        } else {
        steps = Opal.Range.$new(0, steps_count, false).$step(step.$abs())
      };
      result = $send(steps, 'map', [], (TMP_48 = function(i){var self = TMP_48.$$s || this;
if (i == null) i = nil;
      return $rb_plus(self, i)}, TMP_48.$$s = self, TMP_48.$$arity = 1, TMP_48));
      if ((block !== nil)) {
        
        $send(result, 'each', [], (TMP_49 = function(i){var self = TMP_49.$$s || this;
if (i == null) i = nil;
        return Opal.yield1(block, i);}, TMP_49.$$s = self, TMP_49.$$arity = 1, TMP_49));
        return self;
        } else {
        return result
      };
    }, TMP_Date_step_46.$$arity = -2);
    
    Opal.defn(self, '$upto', TMP_Date_upto_50 = function $$upto(max) {
      var self = this, $iter = TMP_Date_upto_50.$$p, block = $iter || nil;

      if ($iter) TMP_Date_upto_50.$$p = null;
      return $send(self, 'step', [max, 1], block.$to_proc())
    }, TMP_Date_upto_50.$$arity = 1);
    
    Opal.defn(self, '$downto', TMP_Date_downto_51 = function $$downto(min) {
      var self = this, $iter = TMP_Date_downto_51.$$p, block = $iter || nil;

      if ($iter) TMP_Date_downto_51.$$p = null;
      return $send(self, 'step', [min, -1], block.$to_proc())
    }, TMP_Date_downto_51.$$arity = 1);
    
    Opal.defn(self, '$wday', TMP_Date_wday_52 = function $$wday() {
      var self = this;

      return self.date.getDay()
    }, TMP_Date_wday_52.$$arity = 0);
    
    Opal.defn(self, '$wednesday?', TMP_Date_wednesday$q_53 = function() {
      var self = this;

      return self.$wday()['$=='](3)
    }, TMP_Date_wednesday$q_53.$$arity = 0);
    
    Opal.defn(self, '$year', TMP_Date_year_54 = function $$year() {
      var self = this;

      return self.date.getFullYear()
    }, TMP_Date_year_54.$$arity = 0);
    
    Opal.defn(self, '$cwday', TMP_Date_cwday_55 = function $$cwday() {
      var self = this;

      return self.date.getDay() || 7;
    }, TMP_Date_cwday_55.$$arity = 0);
    
    Opal.defn(self, '$cweek', TMP_Date_cweek_56 = function $$cweek() {
      var self = this;
