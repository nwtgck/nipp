...
Opal.modules["nodejs/file"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defs(self, '$join', TMP_5 = function ːjoin($a_rest) {
      var self = this, paths;
    ...
    Opal.defs(self, '$size', TMP_8 = function ːsize(path) {
      var $a, self = this;
    ...
    Opal.defs(self, '$open', TMP_9 = function ːopen(path, flags) {
    ...
    Opal.defs(self, '$stat', TMP_10 = function ːstat(path) {
      var $a, self = this;
    ...
    Opal.defs(self, '$mtime', TMP_11 = function ːmtime(path) {
      var self = this;
    ...
    Opal.defn(self, '$write', TMP_13 = function ːwrite(string) {
      var self = this;

      return __fs__.writeSync(self.fd, string);
    }, TMP_13.$$arity = 1);

    Opal.defn(self, '$flush', TMP_14 = function ːflush() {
      var self = this;

      return __fs__.fsyncSync(self.fd);
    }, TMP_14.$$arity = 0);

    Opal.defn(self, '$close', TMP_15 = function ːclose() {
      var self = this;

      return __fs__.closeSync(self.fd);
    }, TMP_15.$$arity = 0);

    return (Opal.defn(self, '$mtime', TMP_16 = function ːmtime() {
      var self = this;
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$mtime', TMP_19 = function ːmtime() {
      var self = this;
...
Opal.modules["nodejs/dir"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function(self) {
      ...
      Opal.defn(self, '$mkdir', TMP_3 = function ːmkdir(path) {
        var self = this;

        return __fs__.mkdirSync(path);
      }, TMP_3.$$arity = 1);
      Opal.defn(self, '$entries', TMP_4 = function ːentries(dirname) {
        var self = this;
