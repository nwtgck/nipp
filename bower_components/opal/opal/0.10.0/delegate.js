...
Opal.modules["delegate"] = function(Opal) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(obj) {
      var self = this;

      return self.$__setobj__(obj);
    }, TMP_1.$$arity = 1);

    return (Opal.defn(self, '$method_missing', TMP_2 = function ːmethod_missing(m, $a_rest) {
  ...
  (function($base, $super) {
    ...
    Opal.defn(self, '$__getobj__', TMP_3 = function ː__getobj__() {
      var self = this;

      return self.delegate_sd_obj;
    }, TMP_3.$$arity = 0);

    return (Opal.defn(self, '$__setobj__', TMP_4 = function ː__setobj__(obj) {
      var self = this;

      return self.delegate_sd_obj = obj;
    }, TMP_4.$$arity = 1), nil) && '__setobj__';
  })($scope.base, $scope.get('Delegator'));
  return (Opal.defn(Opal.Object, '$DelegateClass', TMP_5 = function ːDelegateClass(superklass) {
    var self = this;
