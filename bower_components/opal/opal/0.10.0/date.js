...
Opal.modules["date"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(d) {
        var self = this;
      ...
      Opal.defn(self, '$d', TMP_2 = function ːd() {
        var self = this;
      ...
      Opal.defn(self, '$abs', TMP_7 = function ːabs() {
        var self = this;
      ...
      Opal.defn(self, '$coerce', TMP_11 = function ːcoerce(other) {
      ...
      return (Opal.defn(self, '$to_f', TMP_12 = function ːto_f() {
        var $a, self = this;
    ...
    (function(self) {
      ...
      Opal.defn(self, '$wrap', TMP_13 = function ːwrap(native$) {
      ...
      Opal.defn(self, '$parse', TMP_14 = function ːparse(string, comp) {
        var $a, $b, $c, self = this;
      ...
      Opal.defn(self, '$today', TMP_15 = function ːtoday() {
        var self = this;
    ...
    Opal.defn(self, '$initialize', TMP_17 = function ːinitialize(year, month, day, start) {
      var self = this;
    ...
    Opal.defn(self, '$clone', TMP_28 = function ːclone() {
      var self = this;

      return $scope.get('Date').$wrap(new Date(self.date.getTime()));
    }, TMP_28.$$arity = 0);

    Opal.defn(self, '$day', TMP_29 = function ːday() {
      var self = this;
    ...
    Opal.defn(self, '$jd', TMP_31 = function ːjd() {
      var self = this;
    ...
    Opal.defn(self, '$month', TMP_34 = function ːmonth() {
      var self = this;

      return self.date.getMonth() + 1;
    }, TMP_34.$$arity = 0);

    Opal.defn(self, '$next', TMP_35 = function ːnext() {
      var self = this;

      return $rb_plus(self, 1);
    }, TMP_35.$$arity = 0);

    Opal.defn(self, '$next_day', TMP_36 = function ːnext_day(n) {
      var self = this;
    ...
    Opal.defn(self, '$next_month', TMP_37 = function ːnext_month() {
      var self = this;
    ...
    Opal.defn(self, '$prev_day', TMP_38 = function ːprev_day(n) {
      var self = this;
    ...
    Opal.defn(self, '$prev_month', TMP_39 = function ːprev_month() {
      var self = this;
    ...
    Opal.defn(self, '$strftime', TMP_41 = function ːstrftime(format) {
      var self = this;
    ...
    Opal.defn(self, '$to_s', TMP_44 = function ːto_s() {
      var self = this;
    ...
    Opal.defn(self, '$wday', TMP_46 = function ːwday() {
      var self = this;
    ...
    Opal.defn(self, '$year', TMP_48 = function ːyear() {
      var self = this;

      return self.date.getFullYear();
    }, TMP_48.$$arity = 0);

    Opal.defn(self, '$cwday', TMP_49 = function ːcwday() {
      var self = this;

      return self.date.getDay() || 7;;
    }, TMP_49.$$arity = 0);

    Opal.defn(self, '$cweek', TMP_50 = function ːcweek() {
      var self = this;
