...
Opal.modules["template"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defs(self, '$paths', TMP_3 = function ːpaths() {
      var self = this;
      if (self._cache == null) self._cache = nil;
    ...
    Opal.defn(self, '$initialize', TMP_4 = function ːinitialize(name) {
    ...
    Opal.defn(self, '$inspect', TMP_5 = function ːinspect() {
      var self = this;

      return "#<Template: '" + (self.name) + "'>";
    }, TMP_5.$$arity = 0);

    Opal.defn(self, '$render', TMP_6 = function ːrender(ctx) {
      var $a, $b, self = this;
    ...
    return (function($base, $super) {
      ...
      Opal.defn(self, '$append', TMP_8 = function ːappend(str) {
        var self = this;
      ...
      return (Opal.defn(self, '$join', TMP_9 = function ːjoin() {
        var self = this;
...
Opal.modules["erb"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      Opal.defn(self, '$html_escape', TMP_1 = function ːhtml_escape(str) {
        var self = this;
