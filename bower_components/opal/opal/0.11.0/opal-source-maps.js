...
Opal.modules["opal/source_map"] = function(Opal) {
  ...
  return (function($base, $parent_nesting) {
    ...
    (function($base, $super, $parent_nesting) {
      ...
      var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_SourceMap_initialize_1, TMP_SourceMap_map_3, TMP_SourceMap_as_json_4, TMP_SourceMap_to_json_5, TMP_SourceMap_to_s_6, TMP_SourceMap_magic_comment_7;
      ...
      Opal.defn(self, '$initialize', TMP_SourceMap_initialize_1 = function $$initialize(fragments, file) {
        var self = this;

        
        self.fragments = fragments;
        return (self.file = file);
      }, TMP_SourceMap_initialize_1.$$arity = 2);
      
      Opal.defn(self, '$map', TMP_SourceMap_map_3 = function $$map() {
        var $a, $b, TMP_2, self = this, source_file = nil, generated_line = nil, generated_column = nil, mappings = nil, zero_offset = nil;

        return (self.map = ($truthy($a = self.map) ? $a : ((source_file = $rb_plus(self.$file(), ".rb")), $b = [1, 0], (generated_line = $b[0]), (generated_column = $b[1]), $b, (mappings = $send(self.fragments, 'map', [], (TMP_2 = function(fragment){var self = TMP_2.$$s || this, $c, mapping = nil, source_line = nil, source_column = nil, source_code = nil, source_offset = nil, generated_offset = nil, new_lines = nil;
if (fragment == null) fragment = nil;
          ...
          if ($truthy(($truthy($c = source_line) ? source_column : $c))) {
            
            source_offset = Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Offset').$new(source_line, source_column);
            generated_offset = Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Offset').$new(generated_line, generated_column);
            mapping = Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Mapping').$new(source_file, generated_offset, source_offset, fragment.$source_map_name());};
          new_lines = source_code.$count("\n");
          generated_line = $rb_plus(generated_line, new_lines);
          if ($truthy($rb_gt(new_lines, 0))) {
          ...
          return mapping;}, TMP_2.$$s = self, TMP_2.$$arity = 1, TMP_2))), (function() {if ($truthy(mappings['$any?']())) {
          return nil
          } else {
          
          zero_offset = Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Offset').$new(0, 0);
          return (mappings = [Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Mapping').$new(source_file, zero_offset, zero_offset)]);
        }; return nil; })(), Opal.const_get_qualified(Opal.const_get_qualified('::', 'SourceMap'), 'Map').$new(mappings.$compact()))))
      }, TMP_SourceMap_map_3.$$arity = 0);
      
      Opal.defn(self, '$as_json', TMP_SourceMap_as_json_4 = function $$as_json() {
        var self = this;

        return self.$map().$as_json()
      }, TMP_SourceMap_as_json_4.$$arity = 0);
      
      Opal.defn(self, '$to_json', TMP_SourceMap_to_json_5 = function $$to_json() {
        var self = this;

        return self.$map().$as_json()
      }, TMP_SourceMap_to_json_5.$$arity = 0);
      
      Opal.defn(self, '$to_s', TMP_SourceMap_to_s_6 = function $$to_s() {
        var self = this;

        return self.$map().$to_s()
      }, TMP_SourceMap_to_s_6.$$arity = 0);
      return (Opal.defn(self, '$magic_comment', TMP_SourceMap_magic_comment_7 = function $$magic_comment(map_path) {
        var self = this;

        return "" + "\n//# sourceMappingURL=file://" + (map_path)
      }, TMP_SourceMap_magic_comment_7.$$arity = 1), nil) && 'magic_comment';
    })($nesting[0], null, $nesting)
  })($nesting[0], $nesting);
};
